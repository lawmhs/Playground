...
// associated functions are given by :: like in C++
        ...
        let guess: u32 = guess.trim().parse() // trim eliminates newlines \n, and parse eliminates leading and trailing whitespace
            .expect("Please type a number!"); // this is called "shadowing" where we overwrite the variable guess with another value, typically of a different type
